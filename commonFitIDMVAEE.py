...
"RooCMSShape::backgroundPass(mass, alphaPass[65.995,50.,70.], betaPass[0.05, 0.,0.1], gammaPass[0.04, 0, 1], peakPass[90.0, 70, 80])",
...
"RooCMSShape::backgroundPass(mass, alphaPass[63.75,45.,75.], betaPass[0.04, 0.,0.1], gammaPass[0.04, 0, 1], peakPass[90.0, 70, 80])",
"RooCMSShape::backgroundFail(mass, alphaFail[55.64,45.,75.], betaFail[0.05, 0.,0.1], gammaFail[0.01, 0, 1], peakFail[90.0, 70, 80])",
"FCONV::signalPass(mass, signalPhyPass, signalResPass)",
"FCONV::signalFail(mass, signalPhyFail, signalResFail)",
"efficiency[0.5,0,1]",
"signalFractionInPassing[1.0]"
