...
#import flashgg.Validation.commonFitPreselR9etaEB as common
#import flashgg.Validation.commonFitPreselR9etaEE as common
#import flashgg.Validation.commonFitPreselBkgSystEE as common
#import flashgg.Validation.commonFitPreselEE_TagpT40 as common
...
DataBinningSpecification = cms.PSet(
    ...
    BinToPDFmap = cms.vstring(
        "tight_20p0To40p0_0p0To1p5", 
          "*r9_bin0*abseta_bin0*","passingPresel_0p0To0p85_0p0To1p479",                                                                                 "*r9_bin1*abseta_bin0*","passingPresel_0p85To1p0_0p0To1p479",  
