...
// Fri Feb  3 18:07:28 2017 by ROOT version 6.04/02
// from TTree fitter_tree/fitter_tree
// found on file: TnP_mc_Moriond17.root
//////////////////////////////////////////////////////////

#ifndef TotWeightCheck_h
#define TotWeightCheck_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TotWeightCheck(TTree *tree=0);
   virtual ~TotWeightCheck();
...
#ifdef TotWeightCheck_cxx
TotWeightCheck::TotWeightCheck(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/p/prrout/public/Lowmassanalysis/H2gg2016/CMSSW_8_0_26_patch1/src/flashgg/Validation/test/TnP_MC_RunIISummer16-2_4_1-25ns_Moriond17_R9Transfm_TagPhotonpT35_SYstematics.root");
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Documents/MyComputerHome/Documents/HtoGammaGammaAnalysis/TnP/TnPTree_mc_newID.root");
      if (!f || !f->IsOpen()) {
	f = new TFile("/afs/cern.ch/work/p/prrout/public/Lowmassanalysis/H2gg2016/CMSSW_8_0_26_patch1/src/flashgg/Validation/test/TnP_MC_RunIISummer16-2_4_1-25ns_Moriond17_R9Transfm_TagPhotonpT35_SYstematics.root");
	//f = new TFile("Documents/MyComputerHome/Documents/HtoGammaGammaAnalysis/TnP/TnPTree_mc_newID.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/p/prrout/public/Lowmassanalysis/H2gg2016/CMSSW_8_0_26_patch1/src/flashgg/Validation/test/TnP_MC_RunIISummer16-2_4_1-25ns_Moriond17_R9Transfm_TagPhotonpT35_SYstematics.root:/PhotonToRECO");
      //TDirectory * dir = (TDirectory*)f->Get("Documents/MyComputerHome/Documents/HtoGammaGammaAnalysis/TnP/TnPTree_mc_newID.root:/PhotonToRECO");
...
TotWeightCheck::~TotWeightCheck()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TotWeightCheck::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TotWeightCheck::LoadTree(Long64_t entry)
{
...
void TotWeightCheck::Init(TTree *tree)
{
...
void TotWeightCheck::Show(Long64_t entry)
{
...
Int_t TotWeightCheck::Cut(Long64_t entry)
{
...
#endif // #ifdef TotWeightCheck_cxx
