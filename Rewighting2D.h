...
// Wed Aug  3 13:08:58 2016 by ROOT version 6.04/02
// from TTree fitter_tree/fitter_tree
// found on file: output_numEvent5000_histos.root
//////////////////////////////////////////////////////////

#ifndef Rewighting2D_h
#define Rewighting2D_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Rewighting2D(TTree *tree=0);
   virtual ~Rewighting2D();
...
#ifdef Rewighting2D_cxx
Rewighting2D::Rewighting2D(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
#ifdef SINGLE_TREE
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("TnP_GGH90.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("TnP_GGH90.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("TnP_GGH90.root:/PhotonToRECO");
      ...
      chain->Add("TnP_MC_GluGluHToGG_M125_13TeV_amcatnloFXFX_pythia8_R9etareweighting_NewafterLowmassTransformation.root/PhotonToRECO/fitter_tree");
      chain->Add("TnP_Data_SingleElectron_sethzenz_ReMiniAOD_03Feb2017.root/PhotonToRECO/fitter_tree");

      //  chain->Add("TnP_GGH90.root/PhotonToRECO/fitter_tree");
      // chain->Add("TnP_mc_Moriond17.root/PhotonToRECO/fitter_tree");
      //chain->Add("TnPfullDataset2016SingleElectron/TnPTree_mc_newID.root/PhotonToRECO/fitter_tree");
      tree = chain;
      #endif // SINGLE_TREE                                                                                          
   }
   Init(tree);
...
Rewighting2D::~Rewighting2D()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Rewighting2D::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Rewighting2D::LoadTree(Long64_t entry)
{
...
void Rewighting2D::Init(TTree *tree)
{
...
void Rewighting2D::Show(Long64_t entry)
{
...
Int_t Rewighting2D::Cut(Long64_t entry)
{
